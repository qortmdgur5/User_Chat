			...
			<table class="table table-bordered table-hover" style="text-align: center; border: 1px solid #dddddd">
				...
				<tbody>
					<tr>
						...
						<td style="width: 110px;"><button class="btn btn-primary" onclick="registerCheckhFunction();" type="button">중복체크</button></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td colspan="2"><input onkeyup="passwordCheckFunction();" class="form-control" type="password" id="userPassword2" name="userPassword2" maxlength="20" placeholder="똑같은 비밀번호를 입력하세요."></td>
					</tr>
					<tr>
